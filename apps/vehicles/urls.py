...
from vehicles.views import VehiclesList, VehicleCreate, VehicleView, VehicleUpdate, delete_vehicle
...
urlpatterns = patterns('',
    ...
    url(r'^(?P<vehicle_id>\d+)/delete/$', delete_vehicle, name='vehicle_delete'),
)
